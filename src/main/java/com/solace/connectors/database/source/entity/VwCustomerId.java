...
/**
 * VwCustomerId generated by hbm2java
 */
@Embeddable
public class VwCustomerId  implements java.io.Serializable {
    ...
    public VwCustomerId(BigDecimal customerId) {
        this.customerId = customerId;
    }
    public VwCustomerId(BigDecimal customerId, String adbTrackingid, String DStatus, String sequenceId, String city, String firstName, String lastName, String state, String zip, Date dbtime, Blob blobc, Clob clobc, Date systemtime) {
       this.customerId = customerId;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof VwCustomerId) ) return false;
		 VwCustomerId castOther = ( VwCustomerId ) other; 
